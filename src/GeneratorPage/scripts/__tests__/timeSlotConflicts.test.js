...
describe("Time Slot Conflict Handling", () => {
  ...
  it("should handle weekend time slots correctly", () => {
    ...
    expect(timetables.length).toBeGreaterThan(0);
    expect(timetables[0].courses[0].mainComponents[0].schedule.days).toBe(
      "S U",
    );
  });
});
