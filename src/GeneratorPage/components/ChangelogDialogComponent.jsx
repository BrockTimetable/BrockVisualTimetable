...
const ChangelogDialogComponent = ({ open, handleClose }) => {
    return (
        <Dialog open={open} onClose={handleClose}>
            <DialogTitle>Brock Visual Timetable Generator</DialogTitle>
            <DialogContent>
                ...
                <div>
                    <p style={{ fontSize: '0.775rem' }}>
                        ...
                        by Brock University.<br></br><br></br> The use of this application is at your own discretion. For any official information or updates related to Brock University, please refer directly to the
