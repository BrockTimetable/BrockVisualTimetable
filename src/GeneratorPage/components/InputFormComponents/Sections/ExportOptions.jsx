                            ...
                            <List sx={{ listStyle: "decimal", pl: 2 }}>
                                <ListItem sx={{ display: "list-item" }}>
                                    <ListItemText 
                                        ...
                                        secondary={
                                            <>
                                                Google Calendar: Go to calendar.google.com<br />
                                                Apple Calendar: Open the Calendar app<br />
                                ...
                                <ListItem sx={{ display: "list-item" }}>
                                    <ListItemText 
                                        ...
                                        secondary={
                                            <>
                                                Google Calendar: Click the gear icon (Settings) → Import & Export<br />
                                                Apple Calendar: File → Import<br />
