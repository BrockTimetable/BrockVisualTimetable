...
export default function NoTimetablesDialog({ noTimetablesDialogOpen, handleCloseNoTimetablesDialog }) {
    return (
        <Dialog
        ...
        >
            ...
            <DialogContent>
                ...
                <DialogContentText>1. Adding a course that is not being offered in that duration.</DialogContentText>
                <DialogContentText sx={{ mb: 2 }}>
