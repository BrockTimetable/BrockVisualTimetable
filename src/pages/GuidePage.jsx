            ...
            <Grid item xs={12}>
              <Box m={2}>
                ...
                <Typography variant="body1" gutterBottom>
                  Welcome to the Brock Visual TimeTable! This guide will help
                  you learn everything you need to know about course planning &
                  registration at Brock University. This guide is written by
                  students, for students. We understand the struggles of course
                  registration and have created this platform to help you make
                  the process easier.
                </Typography>
                <Typography variant="body1" gutterBottom>
                  In this guide, you will learn how to find your courses, plan
                  your schedule, and register for courses. This guide is
                  designed to be simple and easy to follow. This guide is for
                  all students at Brock University, including first-year
                  students, upper-year students, and transfer students.
                </Typography>
                <Typography variant="body1" gutterBottom>
                  This guide will be running through creating a first-year
                  computer science co-op student's timetable. The process is the
                  same for all students, but the courses you need to take will
                  be different.
                </Typography>
                <Typography variant="body2" gutterBottom>
                  ...
                  other students. We are not responsible for any errors or
                  issues that may arise from using this tool. Please ensure you
                ...
                <Typography variant="body1" gutterBottom>
                  The first step to course registration is finding the courses
                  you want to take. Go to the{" "}
                  <Link
                ...
                <Box>
                  ...
                  >
                    ...
                    <Collapse in={openCourseCode} timeout="auto" unmountOnExit>
                      <Box m={2}>
                        <Typography variant="body1" gutterBottom>
                          The course code is a unique identifier for each
                          course. Lets use <strong>COSC 1P02</strong> as an
                          example. It is made up of 4 distinct parts:
                        </Typography>
                    ...
                    <Collapse in={openAndOr} timeout="auto" unmountOnExit>
                      <Box m={2}>
                        <Typography variant="body1" gutterBottom>
                          Notice how some courses have <strong>AND</strong> and
                          others have
                          <strong> OR</strong> between them. Looking at the
                          image above, you can see that
                          <strong> COSC 1P02 AND COSC 1P03</strong> are
                          required. This means you must take both courses. In
                          the case of these courses, COSC 1P02 is a prerequisite
                          for COSC 1P03. Assuming you are a first-year student,
                          you will need to take COSC 1P02 in your first term and
                          COSC 1P03 in your second term.
                        </Typography>
                        <Typography variant="body1" gutterBottom>
                          On the other hand,{" "}
                          <strong> COSC 1P50 OR COSC 1P71</strong> are required.
                          This means you only need to take one of the two
                          courses. You can choose to take COSC 1P50 or COSC 1P71
                    ...
                    >
                      <Box m={2}>
                        <Typography variant="body1" gutterBottom>
                          ...
                          term-specific course. This means that you can only
                          take this course in the Winter term. You will need to
                          plan your schedule accordingly to ensure you can take
                          this course.
                        </Typography>
                        <Typography variant="body1" gutterBottom>
                          In the case of SCIE 0N90, this doesn't have much
                          impact on your schedule, as this is a 0 credit course,
                          that you normally take on top of your regular course
                          load.
                        </Typography>
                      </Box>
                    </Collapse>
                    ...
                    <Collapse
                      in={openContextCredits}
                      timeout="auto"
                      unmountOnExit
                    >
                      <Box m={2}>
                        <Typography variant="body1" gutterBottom>
                          Context credits are courses that are required to give
                          you a broader understanding of different fields. At
                          Brock, you need to complete 1.0 context credit in
                          Humanities, Social Sciences, and Sciences. You can
                          find the list of courses that fulfill these
                          requirements{" "}
                          <Link
                    ...
                    <Collapse
                      in={openElectiveCredits}
                      timeout="auto"
                      unmountOnExit
                    >
                      <Box m={2}>
                        <Typography variant="body1" gutterBottom>
                          Elective credits are courses that you can choose
                          freely from any department. These allow you to explore
                          other areas of interest and can be used to fulfill
                          additional requirements or personal interests.
                        </Typography>
                      </Box>
                    </Collapse>
                  </Box>
                ...
                <Typography variant="body1" gutterBottom>
                  Once you have found the courses you need to take, you can
                  start planning your timetable. You can use the{" "}
                ...
                <Typography variant="body1" gutterBottom>
                  When adding courses to the generator, ensure that you are
                  adding the course for the correct term. You can do this by
                  adding D(number), where number is the term number. For fall
                  and winter terms:
                </Typography>
                <List sx={{ listStyle: "decimal", pl: 4 }}>
                  <ListItem sx={{ display: "list-item", py: 0 }}>
                ...
                <Typography variant="body1" gutterBottom>
                  The durations used for spring & summer courses are different.
                  You can find the duration for each course in the{" "}
                  <Link
                ...
                <Typography variant="body1" gutterBottom>
                  ...
                  Visual TimeTable. You can see I've decided to take COSC 1P02,
                  COSC 1P50, MATH 1P66, and ECON 1P92 in my first term, and FILM
                  1F94 as an 8 month course. FILM 1F94 fills the context credit
                  for Humanities, and ECON 1P92 fills half of the context credit
                  for Social Sciences.
                </Typography>
                <Typography variant="body1" gutterBottom>
                  You can also see that I've blocked out every day from 8:00 AM
                  to 9:00 AM. This prevents the generator from scheduling any
                ...
                <Typography variant="body1" gutterBottom>
                  Once you have created your timetable, you can start
                  registering for courses. Log in to your{" "}
                  <Link
                ...
                <Typography variant="body1" gutterBottom>
                  You can then select the term you want to register for and
                  input the course codes for the courses you want to take. Make
                  sure you add the correct components (e.g. lecture, tutorial,
                  lab) for each course.
                </Typography>
                <Typography variant="body1" gutterBottom>
                  Once you add a course, it will show up in the "List Of
                  Registered Courses for Current Registration Period" list at
                  the bottom of the page. The course will be automatically
                  saved, so once it's added, you're good to go!
                </Typography>
              </Box>
            </Grid>
          </Grid>
